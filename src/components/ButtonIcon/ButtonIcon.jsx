...
const typePerClass = {
  bare: 'hover:bg-zinc-200 rounded-lg w-8 h-8 p-1',
  outline: 'text-zinc-900 border border-zinc-200 hover:bg-zinc-50 active:bg-zinc-900 active:text-zinc-50 rounded-lg w-8 h-8 p-1',
...
const typePerClassIcon = {
  ...
  bareRounded: 'text-zinc-400 group-hover:text-zinc-500'
};
