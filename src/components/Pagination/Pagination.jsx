...
const Pagination = ({ totalCount = 0, pageSize = 0, onPageClick = () => { } }) => {
  ...
  return (
    <ResponsivePagination
      ...
      nextLabel={<Icon iconName="ChevronRightIcon" iconClassName="text-zinc-500 w-6 " type="solid" />}
      previousLabel={<Icon iconName="ChevronLeftIcon" iconClassName="text-zinc-500 w-6" type="solid" />}
